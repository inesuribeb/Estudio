...
const projectsData = [
    {
        ...
        images: [
            { src: "/Artaza/1.png", alt: "descripción2" },
            { src: "/Artaza/2.png", alt: "descripción2" },
            { src: "/Artaza/3.png", alt: "descripción2" },
            { src: "/Artaza/4.png", alt: "descripción2" },
            { src: "/Artaza/5.png", alt: "descripción2" },
            { src: "/Artaza/6.png", alt: "descripción2" },
            { src: "/Artaza/7.png", alt: "descripción2" },
        ],
        sector: {
            es: ["Inmobiliario"],
            en: ["Real Estate"]
